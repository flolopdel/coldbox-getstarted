...
<div class="row">
	...
	<div class="col-md-6">
		<cfif not settingExists("FakeSetting")>
			<p>Fake Setting Does not Exist</p>
		<cfelse>
			<p>Fake Setting Exist, not possible</p>
		</cfif>
		<p>My dynamic setting is #getSetting("MyDynamicSetting")#</p>
	</div>
...
<div class="row">
	...
	<div class="col-md-6">
		<p>#rc.pageValue#</p>
		<p>#event.getValue("pageExists",false)#</p>
		<p>#event.getValue("page")#</p>
		<p>#rc.page#</p>
	</div>
