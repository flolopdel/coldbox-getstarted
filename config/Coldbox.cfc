component{
	...
	function configure(){
		...
		coldbox = {
			//Application Setup
			appName 				= "ColdBox advanced by Luis",
			eventName 				= "event",

			//Development Settings
			reinitPassword			= "resetPwd",
		...
		// custom settings
		settings = {
			myName 		= "Florindo López Delgado",
			myCities 	= ["Sevilla", "Lelystad"],
			myAddress 	= {
				street = "Manuela Nogales",
				number = "4",
				floor  = "Atico",
			},
			MyDynamicSetting = "MyDynamicSetting",
		};
